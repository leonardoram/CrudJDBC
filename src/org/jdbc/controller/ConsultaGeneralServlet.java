...
/**
 * Servlet implementation class ConsultaGeneralServlet
 */
@WebServlet("/ConsultaGeneralServlet")
public class ConsultaGeneralServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//response.getWriter().append("asdffsaadffa");
		...
		try 
		{
			...
			rs = stmn.executeQuery("SELECT * FROM autores");
			while(rs.next())
			{
